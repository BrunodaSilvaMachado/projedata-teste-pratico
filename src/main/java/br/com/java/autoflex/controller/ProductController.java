 ...
 * Handles CRUD operations for products and their material compositions.
 */
@RestController
...
public class ProductController {
    ...
    /**
     * Creates a new product with associated materials.
     *
     * @param productRequestDTO Product data including code, name, price, and materials
    ...
    /**
     * Retrieves all products with their materials.
     *
    ...
    /**
     * Updates an existing product and its materials.
     *
     * @param id Product ID
    ...
    /**
     * Deletes a product and its associated materials.
     *
     * @param id Product ID
     */
    @DeleteMapping("/{id}")
